...
for novelty_frac in [0.25, 0.5]:
  ...
  print(f"Loaded data shapes: train - {df_train.shape}, validation - {df_val.shape}.")
  ...
  print(f"There are {num_categories} known categories to predict.")
  #------------------------------------------
  ...
  for i, feature_set_tuple  in enumerate(feature_sets):
    ...
    def objective(trial):
      ...
      params.update({
        ...
        "num_leaves": trial.suggest_int("num_leaves", 330, 345),
